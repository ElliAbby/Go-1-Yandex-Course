// Композиция интерфейсов в Go происходит, когда один или несколько интерфейсов включаются в определение другого.
// Новый интерфейс наследует их методы и требования:
package main
