// Задача 1: Подсчёт количества повторений элементов в списке
...
func countOccurrences(nums []int) map[int]int {
    occurrences := make(map[int]int) // пустая мапа, которая будет хранить количество повторений каждого числа.
